  ...
  const footerLinks = [
    {
      title: "Get Involved",
      links: [
        { href: "/partner-with-us", label: "Partner with Us", icon: Briefcase },
        { href: "/hire-from-viral", label: "Hire from Viral", icon: Users },
      ],
    },
    {
      title: "Support",
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-muted-foreground mb-6 max-w-md leading-relaxed">
              The premier community for marketing students and professionals to network, compete, learn, and earn while building their careers in the digital marketing space.
            </p>
          </div>
        ...
        <div className="border-t border-border/20 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="text-muted-foreground text-sm">
              © 2025 Viral. All rights reserved. Built for marketing students, by marketing students.
            </div>
            <div className="flex items-center gap-6">
              <a href="/privacy-policy" className="text-muted-foreground hover:text-viral-purple transition-colors text-sm">
                Privacy Policy
              </a>
              <a href="/terms-of-service" className="text-muted-foreground hover:text-viral-purple transition-colors text-sm">
                Terms of Service
              </a>
              <a href="/cookie-policy" className="text-muted-foreground hover:text-viral-purple transition-colors text-sm">
                Cookie Policy
              </a>
            </div>
          </div>
