...
const About = () => {
  ...
  const highlights = [
    ...
    },
    {
      ...
      description: "Every challenge designed to build impressive portfolio pieces"
    },
    {
      ...
      <main className="pt-20">
        ...
        <section className="py-16 px-4">
          <div className="container mx-auto max-w-6xl">
            <Card className="glass-card border-viral-purple/20">
        ...
        <section className="py-16 px-4">
          <div className="container mx-auto max-w-6xl">
            <h2 className="text-3xl font-bold text-center mb-12">Why Choose Viral?</h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {highlights.map((highlight, index) => (
                <Card key={index} className="glass-card border-viral-purple/20 hover:border-viral-pink/40 transition-all duration-300">
        ...
        {/* Benefits Section */}
        <section className="py-16 px-4 bg-gradient-to-br from-viral-purple/5 to-viral-pink/5">
        ...
        <section className="py-20 px-4">
          <div className="container mx-auto max-w-4xl text-center">
            ...
            <Button size="lg" className="viral-gradient text-white px-8 py-3 text-lg">
              Get Started Today
            </Button>
          </div>
        </section>
